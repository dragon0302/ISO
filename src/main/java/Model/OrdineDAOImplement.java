...
public class OrdineDAOImplement implements OrdineDAO {
    ...
    public synchronized void DoSave(Ordine ordine) throws SQLException {
        ...
        try {
            ...
            query = conn.prepareStatement("INSERT INTO " + TABLE_NAME + "(Data_Ordine,Prezzo_tot,Lista_prodotti,ID_carrello,ID_indirizzo)" + " VALUES (?,?,?,?,?)");
    ...
    public ArrayList<Ordine> getOrders() throws SQLException {
        ...
        try{
            ...
            while (rs.next()) {
                ...
                Ordine o = new Ordine(data_ordine,prezzo,prodotti,id_carrello,id_indirizzo);
    ...
    public ArrayList<Ordine> getOrdersByUser (int ID_carrello) throws SQLException{
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Integer id_carrello = rs.getInt(5);
                Integer id_indirizzo = rs.getInt(6);
                Ordine o = new Ordine(DataOrdine,prezzo,prodotti,id_carrello,id_indirizzo);
                o.setIdOrdine(id_ordine);
                ordini.add(o);
            }
